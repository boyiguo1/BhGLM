...
bglm_spline <- function (formula, family=gaussian, data, offset, weights, subset, na.action, 
        ...
        for (iter in 1:control$maxit) {
            ...
            if (iter > 1) {
              ...
              if (prior == "mde" | prior == "mt") {
                ...
                #TODO: update the p dimention accordingly when there is parametric terms
                p <- out[[2]]
                if (!is.matrix(group))
